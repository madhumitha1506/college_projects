                        ...
                        while ($row = mysqli_fetch_assoc($res)) 
                        {
                           ...
                           ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo SITEURL;?>admin/updatecategory.php?id=<?php echo $id;?>" class="btn-secondary">Update</a>
                                    <a href="<?php echo SITEURL;?>admin/deletecategory.php?id=<?php echo $id;?>&image_name=<?php echo $image_name;?>" class="btn-danger">Delete</a>
                                </td>
